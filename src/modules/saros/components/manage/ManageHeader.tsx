...
import type { SarosManageTab } from '../../state'
...
interface ManageHeaderProps {
  ...
  activeTab: SarosManageTab
  onTabChange: (tab: SarosManageTab) => void
}
...
const ManageHeader = ({
  ...
  const tabs: Array<{ id: SarosManageTab; label: string; icon: typeof PlusCircle }> = [
