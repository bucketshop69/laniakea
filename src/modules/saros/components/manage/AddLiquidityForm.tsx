...
import type { LiquidityShape } from '@saros-finance/dlmm-sdk/types/services'
...
interface AddLiquidityFormProps {
  ...
  onShapeChange: (shape: LiquidityShape) => void
  binData: SarosBinLiquidityPoint[]
  binLoading: boolean
  activeBinId: number | null
  minBinId: number | null
  maxBinId: number | null
  onRangeChange: (minBin: number, maxBin: number) => void
  baseSymbol: string
  quoteSymbol: string
  ...
  return (
    <div className="flex h-full flex-col gap-2 rounded-xl border border-border/40 p-2 text-xs">
      ...
      <div className="relative h-[220px] rounded-lg border border-border/40 bg-card/30 p-2">
        ...
        ) : activeBinId !== null && minBinId !== null && maxBinId !== null ? (
          <BinChart
            binData={binData}
