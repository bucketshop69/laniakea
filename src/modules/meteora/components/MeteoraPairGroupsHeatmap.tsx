...
export const MeteoraPairGroupsHeatmap = ({
  ...
  const topCardValueClass = isCompact ? 'text-base font-semibold text-primary' : 'text-2xl text-primary'
  ...
  const stackedValueClass = isCompact ? 'text-sm text-primary leading-tight' : 'text-lg text-primary'
